...
![Positioning the windows](images/position.png)

Now, lets add the player (P) pin to the map. I'm right at casino entrance, so i'll place it there:

![Positioning player pin](images/positionPlayerPin.png)
...
![Placed all the pins](images/placedAllThePins.png)

Click on the start button to init survey flow:

![Clicking on the start button](images/startsurvey.png)
